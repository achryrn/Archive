...
- **Study tools** - Backend for my personal spaced-repetition and study session tracker
...
I run this with systemd and Nginx. systemd manages the process lifecycle and restarts on failure. Nginx sits in front as a reverse proxy and handles TLS termination. Set `ALLOWED_ORIGINS` to your domain only.
...
- [Lyricryn](https://github.com/achryrn/Archive/blob/main/lyricryn-README.md) - The Android app that connects to this backend
